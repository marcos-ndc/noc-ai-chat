        ...
        <div className="flex items-center gap-3">
          ...
          {user?.profile === 'admin' && (
            <button
              ...
              title="Admin"
              className="w-7 h-7 rounded-lg border border-noc-border/60 text-noc-muted hover:border-noc-accent/60 hover:text-noc-accent transition-all duration-200 flex items-center justify-center"
            >
